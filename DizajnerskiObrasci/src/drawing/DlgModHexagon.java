...
public class DlgModHexagon extends JDialog{
	...
	public static void main(String[] args) {
		try {
			DlgModHexagon dlgModHexagon = new DlgModHexagon();
			dlgModHexagon.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
			dlgModHexagon.setVisible(true);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
